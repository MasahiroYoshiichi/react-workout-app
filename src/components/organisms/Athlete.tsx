...
const Athlete: FC<Props> = ({course, detailFlag}) => {
    ...
    return (
        <>
            ...
            <div className={detailFlag === 'athlete' ? 'flex h-full' : 'flex h-2/3'}>
                <div className="w-2/4 pt-8 bg-gray-200">
                    ...
                    {detailFlag === 'athlete' ?
                        ...
                        <div className="py-10 text-center">
                            <Link className="bg-white text-2xl text-black hover:text-red-500 font-bold rounded-full py-4 px-8"
                                  to={"/course/athlete"}>
                                コース詳細
                            </Link>
                        </div>
